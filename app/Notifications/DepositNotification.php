...
class DepositNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('This is to notify you that your deposit is posted successfully and our admin are reviewing with your transaction, if confirmed your deposit will be posted in the next 1 hour.')
