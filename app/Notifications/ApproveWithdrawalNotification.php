...
class ApproveWithdrawalNotification extends Notification
{
    use Queueable;
    private $new_user;
    private $trans;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('This is to notify you that your withdral is approved and have been sent to your wallet address.')
