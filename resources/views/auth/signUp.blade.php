    ...
    <section class="sign-in">
        <div class="container-fuild">
            <div class="row">
                <div class="col-lg-6">
                    <div class="pack">
                        <img src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1667565754/EProd%20Images/Group_1778_yjmoaa.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <input type="tel" placeholder="Enter your Full Name" name="phone" class="input" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!--Phone number-->
